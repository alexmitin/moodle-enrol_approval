...
/**
 * CLI update for self enrolments, use for debugging or immediate update of all courses.
 *
 * Notes:
...
Example:
\$ sudo -u www-data /usr/bin/php enrol/approval/cli/sync.php
";
...
if (!enrol_is_enabled('approval')) {
    cli_error('enrol_approval plugin is disabled, synchronisation stopped', 2);
}
