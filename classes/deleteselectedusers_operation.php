...
/**
 * Contains class enrol_approval_deleteselectedusers_operation
 *
...
/**
 * A bulk operation for the approval enrolment plugin to delete selected users enrolments.
 *
 * @package   enrol_approval
 * @copyright 2015 Alex Mitin
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_approval_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_approval');
    }
    ...
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_approval');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_approval');
        return new enrol_approval_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability('enrol/approval:unenrol', $manager->get_context())) {
            return false;
        }
