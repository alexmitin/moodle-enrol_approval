...
/**
 * Contains class enrol_approval_approveselectedusers_operation
 *
...
/**
 * A bulk operation for the approval enrolment plugin to approve selected users enrolments.
 *
 * @package   enrol_approval
 * @copyright 2015 Alex Mitin
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_approval_approveselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('approveselectedusers', 'enrol_approval');
    }
    ...
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkapproveenrolment', 'enrol_approval');
        $defaultcustomdata['button'] = get_string('approveusers', 'enrol_approval');
        return new enrol_approval_approveselectedusers_form($defaultaction, $defaultcustomdata);
    }
