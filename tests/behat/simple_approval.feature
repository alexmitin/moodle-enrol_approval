...
Feature: User is able to apply and teacher is able to approve enrolments
  ...
  @javascript
  Scenario: Teacher approves a single enrolment of a student
    When I log in as "student1"
    And I follow "Course 1"
    And I press "Enrol me"
    Then I should not see "Test course contents"
    And I should not see "Enrol me"
  ...
  @javascript
  Scenario: Teacher declines a single enrolment of a student
    When I log in as "student1"
    And I follow "Course 1"
    And I press "Enrol me"
    Then I should not see "Test course contents"
